     ...
     t = "undefined" != typeof t && t.Math == Math ? t : "undefined" != typeof self && self.Math == Math ? self : Function("return this")(), e.fn.tab = function(i) {
         ...
         return r.each(function() {
             ...
             v = {
                 ...
                 bind: {
                     events: function() {
                         e.isWindow(k) || (v.debug("Attaching tab activation events to element", S), S.on("click" + C, v.event.click))
                     }
                 },
                 determineTabs: function() {
                     var t;
                 ...
                 changeTab: function(a) {
                     ...
                     a = v.utilities.arrayToPath(r), e.each(r, function(t, n) {
                         ...
                         if (v.verbose("Looking for tab", n), g) {
                             ...
                             if (a.search("/") != -1 || "" === a) return v.error(P.missingTab, S, f, b), !1;
                     ...
                     content: function(t, a) {
                         var i, o, r = v.get.tabElement(t),
                             s = {
                                 ...
                                 onSuccess: function(e) {
                                     "response" == T.cacheType && v.cache.add(a, e), v.update.content(t, e), t == p ? (v.debug("Content loaded", t), v.activate.tab(t)) : v.debug("Content loaded in background", t), T.onFirstLoad.call(r[0], t, m, y), T.onLoad.call(r[0], t, m, y), "string" == typeof T.cacheType && "dom" == T.cacheType.toLowerCase() && r.children().length > 0 ? setTimeout(function() {
                                         var e = r.children().clone(!0);
                 ...
                 get: {
                     ...
                     defaultPath: function(e) {
                         var t = r.filter("[data-" + x.tab + '^="' + e + '/"]').eq(0),
                             a = t.data(x.tab) || !1;
                         if (a) {
                             if (v.debug("Found default tab", a), w < T.maxDepth) return w++, v.get.defaultPath(a);
                             v.error(P.recursion)
                 ...
                 invoke: function(t, a, i) {
                     var r, s, c, l = I;
                     return a = a || b, i = k || i, "string" == typeof t && l !== n && (t = t.split(/[\. ]/), r = t.length - 1, e.each(t, function(a, i) {
