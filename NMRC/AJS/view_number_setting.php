               ...
               <div class="row">
                  <div class="col-md-3" >
                     <div class="form-group">
                        <input type="date" class="form-control" name="game_date" value="<?php  if(!empty($_GET['game_date'])){ echo $_GET['game_date'];} else{ echo date('Y-m-d'); }?>">
                     </div>
                  </div>
                  <div class="col-md-3">
                     <div class="form-group">
                  ...
                  <table id="myTable" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%" >
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td style="text-align: center;"><?php echo $row['added_time'];?></td>
