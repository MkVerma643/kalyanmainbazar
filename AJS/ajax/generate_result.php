...
<div class="row form-group">
    ...
    // $batch_1=explode(",",$row['batch_1']);
       ...
       for ($i=0; $i <12 ; $i++) { 
    ?>
    <div class="col"><input type="text"  id="batch_1<?php echo $i ?>" name=batch_1[] value="<?php echo $batch_1_result_arr[$i]; ?>" class="is-valid form-control-success form-control number-input" style="font-size: 15px;"   maxlength="3"></div>
 ...
 <div class="row form-group">
    <div class="col col-md-2"><label for="select" class=" form-control-label">Double  Pana's</label></div>
    <?php 
    // $batch_2=explode(",",$row['batch_2']);
       for ($i=0; $i <9 ; $i++) { ?>
    <div class="col col-md-1" style="text-align: center; margin: 0 auto;"><input type="text" id="batch_2<?php echo $i ?>" name=batch_2[]  value="<?php echo $batch_2_result_arr[$i]; ?>"  class="is-valid form-control-success form-control number-input" style="font-size: 15px;" maxlength="3" ></div>
     <script type="text/javascript">
 ...
 <div class="row form-group">
    ...
    // $batch_3=explode(",",$row['batch_3']);
       for ($i=0; $i <1 ; $i++) { ?>
    <div class="col col-md-1" style="text-align: center; margin-left:35%;"><input type="text" id="batch_3<?php echo $i ?>"  name=batch_3[] value="<?php echo $batch_3_result_arr[$i]; ?>"  class="is-valid form-control-success form-control number-input" style="font-size: 15px;" maxlength="3"  ></div>
     <script type="text/javascript">
